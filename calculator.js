...
(function (root) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'foot.credit':          'Ideated, designed and implemented by <strong>David Carrascosa Bolaños</strong>. Built with the support of AI-assisted coding tools.',
    ...
    es: {
      ...
      'foot.credit':          'Ideado, diseñado e implementado por <strong>David Carrascosa Bolaños</strong>. Construido con el apoyo de herramientas de codificación asistidas por IA.',
